...
#define STRING_CONFIG_H_AUTHOR "(Freek Heining, v1.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
  #define DEFAULT_Kp 19.59
  #define DEFAULT_Ki 1.40
  #define DEFAULT_Kd 68.32
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 112.65
  #define DEFAULT_bedKi 21.96
  #define DEFAULT_bedKd 385.30
...
#define X_MIN_POS 4 // Endstop min X = +3mm!)
#define Y_MIN_POS -3 // move the head 3 mm to the back (or the plate forward) to place the nozzle at Y = 0
#define Z_MIN_POS 0
